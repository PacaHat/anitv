        ...
        <div>
            <footer className="bg-[#151518] mt-10">
                    ...
                    <div className="lg:flex lg:justify-between">
                        <div className="mb-6 lg:mb-0">
                            <Link className="flex items-center w-fit" href="/">
                                <p className="Airin self-center !text-4xl tracking-wider font-medium whitespace-nowrap dark:text-white">Anipaca</p>
                            </Link>
                            <p className="lg:text-[0.8rem] text-[0.7rem] text-[#ffffffb2] lg:w-[520px]">
                ...
                <div className="mx-auto w-full lg:max-w-[83%] lg:flex lg:items-center lg:justify-between lg:text-[0.8rem] text-[0.7rem] text-[#ffffffb2] py-3">
                    <span className="sm:text-center ms-5 lg:ms-0">© {year} <Link href="/" className="hover:text-white">Anipaca™</Link> | Made by <span className="font-bold" >PacaHat</span>
                    </span>
                    <div className="flex mt-4 lg:justify-center lg:mt-0">
                        <Link href="https://github.com/PacaHat" target="_blank" className=" hover:text-gray-900 dark:hover:text-white ms-5 lg:ms-0">
                        ...
                        <Link href="https://discord.gg/aVvqx77RGs" target="_blank" className=" hover:text-gray-900 dark:hover:text-white ms-5">
