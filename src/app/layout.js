...
const APP_NAME = "Anipaca";
const APP_DEFAULT_TITLE = "Anipaca - Watch Anime Online";
const APP_DESCRIPTION = "Discover a world of anime without interruptions on Anipaca! Watch your favorite series for free, with no ads to disrupt your viewing experience. Join now and immerse yourself in the captivating stories and vibrant characters that Anipaca has to offer!";
